...
import {
  FaFacebook, FaInstagram, FaTwitter, FaEnvelope, FaPhone,
  FaPaypal, FaApple, FaGoogle, FaMicrosoft, FaAmazon, FaSpotify,
  FaUserGraduate, FaBuilding, FaRocket
...
// ===================================================================
// SECTION 2: STATIC DATA (Unchanged)
// ===================================================================
...
const HomePage = () => {
  ...
  return (
    <div className="home-page-wrapper">
      ...
      <section className="home-section hero-section">
        ...
        <div className="home-content-container">
          <div className="hero-content animated-content">
            ...
            <p>Welcome to the NexusLink, the premier ecosystem designed to bridge the gap between emerging talent and innovative companies. Our mission is to empower the next generation of professionals by providing a centralized hub to connect, collaborate, and grow.</p>
          </div>
        </div>
      </section>

      {/* --- REVAMPED PERSONA SECTION --- */}
        ...
        <div className="home-content-container">
          ...
          <div className="persona-cards-grid">
            <Link to="/talent" className="persona-card student-card">
              ...
              <div className="persona-card-icon-wrapper"><div className="persona-card-icon"><FaUserGraduate /></div></div><p>Showcase your skills, discover internships, and connect with companies that match your ambition.</p></div>
            ...
            <Link to="/advertisements" className="persona-card company-card">
              <div className="persona-card-content">
                <h3>A Company</h3>
                <div className="persona-card-icon-wrapper"><div className="persona-card-icon"><FaBuilding /></div></div>
                <p>Access a curated pool of top-tier talent, post job openings, and build your dream team effortlessly.</p></div>
            ...
            <Link to="/startup" className="persona-card startup-card">
              ...
              <div className="persona-card-icon-wrapper"><div className="persona-card-icon"><FaRocket /></div></div>
              <p>Share your groundbreaking vision, find co-founders, and connect with a vibrant community of builders.</p></div>
      ...
      {/* --- MERGED ABOUT SECTION (Unchanged) --- */}
      <section ref={aboutSectionRef} className="home-section about-section">
        <div className="home-content-container">
          ...
          <div className="large-stats-grid">
            <div className="stat-item"><CountUpNumber target={8000} suffix="+" isVisible={isStatsVisible} /><div className="stat-title">Matches Made</div></div>
            <div className="stat-item"><CountUpNumber target={150} suffix="K+" isVisible={isStatsVisible} /><div className="stat-title">Tech Jobs</div></div>
            <div className="stat-item"><CountUpNumber target={1000} suffix="+" isVisible={isStatsVisible} /><div className="stat-title">Candidates</div></div>
          </div>
        </div>
      </section>
